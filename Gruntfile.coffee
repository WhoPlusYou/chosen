...
"""
    ...
    copy:
      js:
        ...
        dest: '../WhoPlusYou-Html5/public/js'
      css:
        expand: true
        cwd: 'public/'
        src: 'chosen.css'
        dest: '../WhoPlusYou-Html5/public/css'

    exec:
      gulp:
        cmd: 'gulp'
        cwd: '../WhoPlusYou-Html5/'
  ...
  grunt.registerTask 'build-export',  ['coffee', 'compass', 'concat', 'uglify', 'cssmin', 'package-bower', 'copy']
  grunt.registerTask 'build-export-js-gulp',  ['coffee', 'compass', 'concat', 'uglify', 'cssmin', 'package-bower', 'copy:js', 'exec']
